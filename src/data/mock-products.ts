...
const specialProducts: ProductInput[] = [
  ...
  productInput("black-bolt-binder-collection", "Black Bolt Binder Collection", "Binder Collection", 29.99, "2025-07-18", "Scarlet & Violet - Black Bolt", svSources),
  ...
  productInput("white-flare-binder-collection", "White Flare Binder Collection", "Binder Collection", 29.99, "2025-07-18", "Scarlet & Violet - White Flare", svSources),
  productInput("unova-poster-collection", "Unova Poster Collection", "Poster Collection", 15.99, "2025-07-18", "Scarlet & Violet - Black Bolt & White Flare", svSources),
  productInput("unova-mini-tin", "Unova Mini Tin", "Mini Tin", 9.99, "2025-07-18", "Scarlet & Violet - Black Bolt & White Flare", svSources),
  productInput("black-bolt-tech-sticker-collection-reuniclus", "Black Bolt Tech Sticker Collection - Reuniclus", "Tech Sticker Collection", 15.99, "2025-08-01", "Scarlet & Violet - Black Bolt", svSources),
  productInput("white-flare-tech-sticker-collection-gothitelle", "White Flare Tech Sticker Collection - Gothitelle", "Tech Sticker Collection", 15.99, "2025-08-01", "Scarlet & Violet - White Flare", svSources),
  productInput("unova-victini-illustration-collection", "Unova Victini Illustration Collection", "Illustration Collection", 21.99, "2025-08-01", "Scarlet & Violet - Black Bolt & White Flare", svSources),
  productInput("black-bolt-booster-bundle", "Black Bolt Booster Bundle", "Booster Bundle", 26.94, "2025-08-22", "Scarlet & Violet - Black Bolt", recentPriceSources),
  productInput("white-flare-booster-bundle", "White Flare Booster Bundle", "Booster Bundle", 26.94, "2025-08-22", "Scarlet & Violet - White Flare", recentPriceSources),
